...
import io.github.jhipster.application.NewoApp12App;
 ...
 */
@SpringBootTest(classes = NewoApp12App.class)
public class ChatGrupoResourceIT {
    ...
    public void getAllChatGruposByFechaIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the chatGrupoList where fecha is greater than or equal to DEFAULT_FECHA
        defaultChatGrupoShouldBeFound("fecha.greaterThanOrEqual=" + DEFAULT_FECHA);

        // Get all the chatGrupoList where fecha is greater than or equal to UPDATED_FECHA
        defaultChatGrupoShouldNotBeFound("fecha.greaterThanOrEqual=" + UPDATED_FECHA);
    }

    @Test
    @Transactional
    public void getAllChatGruposByFechaIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        chatGrupoRepository.saveAndFlush(chatGrupo);

        // Get all the chatGrupoList where fecha is less than or equal to DEFAULT_FECHA
        defaultChatGrupoShouldBeFound("fecha.lessThanOrEqual=" + DEFAULT_FECHA);

        // Get all the chatGrupoList where fecha is less than or equal to SMALLER_FECHA
        defaultChatGrupoShouldNotBeFound("fecha.lessThanOrEqual=" + SMALLER_FECHA);
    }
    ...
    public void getAllChatGruposByFechaIsLessThanSomething() throws Exception {
        ...
        // Get all the chatGrupoList where fecha is less than DEFAULT_FECHA
        defaultChatGrupoShouldNotBeFound("fecha.lessThan=" + DEFAULT_FECHA);

        // Get all the chatGrupoList where fecha is less than UPDATED_FECHA
        defaultChatGrupoShouldBeFound("fecha.lessThan=" + UPDATED_FECHA);
    }

    @Test
    @Transactional
    public void getAllChatGruposByFechaIsGreaterThanSomething() throws Exception {
        // Initialize the database
        chatGrupoRepository.saveAndFlush(chatGrupo);

        // Get all the chatGrupoList where fecha is greater than DEFAULT_FECHA
        defaultChatGrupoShouldNotBeFound("fecha.greaterThan=" + DEFAULT_FECHA);

        // Get all the chatGrupoList where fecha is greater than SMALLER_FECHA
        defaultChatGrupoShouldBeFound("fecha.greaterThan=" + SMALLER_FECHA);
    }
