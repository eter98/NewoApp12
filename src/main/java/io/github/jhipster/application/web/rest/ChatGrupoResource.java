...
public class ChatGrupoResource {
    ...
    public ResponseEntity<List<ChatGrupo>> getAllChatGrupos(ChatGrupoCriteria criteria, Pageable pageable) {
    ...
    */
    ...
    public ResponseEntity<List<ChatGrupo>> searchChatGrupos(@RequestParam String query, Pageable pageable) {
