...
public class ChatListGrupoResource {
    ...
    public ResponseEntity<List<ChatListGrupo>> getAllChatListGrupos(ChatListGrupoCriteria criteria, Pageable pageable) {
    ...
    */
    ...
    public ResponseEntity<List<ChatListGrupo>> searchChatListGrupos(@RequestParam String query, Pageable pageable) {
